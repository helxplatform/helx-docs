...
2. helm
install **release-name** appstore/ -n
...
PRP) or serviceaccount.yaml(for SciDas and Braini) from /devops/helx to
/devops/helx/charts/tycho-api/templates/.
